...
import br.com.fiap.rastreamentoentregaskafka.KafkaGateway;
...
public class WebController {
    ...
    public WebController(KafkaGateway kafka, EstadoAtualView estado, AlertasView alertas) {
        this.kafka = kafka; this.estado = estado; this.alertas = alertas;
    }
